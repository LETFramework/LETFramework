...
public class ElasticSketchBased extends TopkPart implements Serializable {
    private int bucketNum;
    private int[] nCounters;
    private Bucket[] buckets;
    ElasticSketchBased(int memInBytes) {
    ...
    public Pair<Integer, Pair<Integer, Integer>> insert(Integer key, Integer val) {
        ...
        buckets[pos].setVal(minCounter, val+0x80000000);
